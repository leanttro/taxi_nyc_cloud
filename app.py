...
app = Flask(__name__)
CORS(app)  # libera CORS para qualquer front-end
...
def get_db_connection():
    try:
        db_url = os.environ['DATABASE_URL']  # pega a URL do banco de dados do Render
...
def home():
    return "API do Simulador de Táxi está funcionando! Use /predict para simular."
